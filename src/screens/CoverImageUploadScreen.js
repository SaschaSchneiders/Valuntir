...
export default function CoverImageUploadScreen({ navigation }) {
  ...
  const handleSave = () => {
    ...
    console.log('Titelbild speichern:', selectedImageUri);
    Alert.alert('Erfolgreich', 'Titelbild wurde gespeichert!', [
      { text: 'OK', onPress: () => navigation.goBack() }
    ]);
  };
      ...
      >
        <SafeAreaView style={styles.safeArea} edges={['top']}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.title}>Titelbild</Text>
            <TouchableOpacity 
          ...
          {/* Cover Image Preview - Oben, volle Breite */}
          ...
          <View style={styles.helperSection}>
            <Text style={styles.helperText}>
              {selectedImageUri ? 'Wähle ein anderes Foto aus der Galerie' : 'Format 3:1 – Empfohlen: 1200×400 Pixel'}
            </Text>
          </View>
