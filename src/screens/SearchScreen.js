...
export default function SearchScreen({ navigation: navProp }) {
  ...
  const providers = [
    ...
    {
      id: 8,
      name: 'Textagentur Wortschatz',
      username: '@wortschatz_texte',
      category: 'Content',
      location: 'Leipzig',
      successRate: 54,
      reviewCount: 9,
    ...
    {
      id: 9,
      name: 'SEO Berater Online',
      username: '@seo_berater',
    ...
    {
      id: 10,
      name: 'Grafik & Print GmbH',
      username: '@grafik_print',
